...
public
  ...
  class procedure changeWindowSize(form: TForm; panel: TPanel; control:
                  TTMSFNCBloxControl; image: TImage); overload;
...
implementation
  ...
  class procedure TFormController.changeWindowSize(form: TForm; panel: TPanel;
                control: TTMSFNCBloxControl; image: TImage);
  begin
  ...
  // Setzen der neuen Breite und Höhe des Bildes entsprechend der Fenstergröße
  Image.Width := Round(Image.Width * ScaleFactor);
  Image.Height := Round(Image.Height * ScaleFactor); }
  end;
