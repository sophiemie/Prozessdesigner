{
  ...
  Unit UNodeTest: Testunit der Knotenklassen
}
unit UNodeTest;
...
[TestFixture]
  ...
  public
    ...
    procedure TestGetDescription(_Result: String);
    [TestCase('Test gebe Textfeld Beschreibung','E: Abbruch')]
    procedure TestGetDescription_Text(_Result: String);
...
[TestFixture]
  ...
  public
    ...
    procedure TestGetDescription(_Result: String);
    [TestCase('Test gebe Textfeld Beschreibung','HT: Reiseantrag')]
    procedure TestGetDescription_Text(_Result: String);
...
[TestFixture]
  ...
  public
    ...
    procedure TestGetDescription(_Result: String);
    [TestCase('Test gebe Textfeld Beschreibung','HD: Leader')]
    procedure TestGetDescription_Text(_Result: String);
  ...
  public
    ...
    procedure TestGetDescription(_Result: String);
    [TestCase('Test gebe Textfeld Beschreibung','MT: Send Mail')]
    procedure TestGetDescription_Text(_Result: String);
...
[TestFixture]
  ...
  public
    ...
    procedure TestGetDescription(_Result: String);
    [TestCase('Test gebe Textfeld Beschreibung','MD: Anmeldung')]
    procedure TestGetDescription_Text(_Result: String);
...
procedure TestTEnd.TestGetDescription_Text(_Result: String);
var
  R : String;
begin
  R := aEndNode.Text;
...
procedure TestTHumanTask.TestGetDescription_Text(_Result: String);
var
  R : String;
begin
  R := aHTNode.Text;
...
procedure TestTHumanDecision.TestGetDescription_Text(_Result: String);
var
  R : String;
begin
  R := aHDNode.Text;
...
procedure TestTMachineTask.TestGetDescription_Text(_Result: String);
var
  R : String;
begin
  R := aMTNode.Text;
...
procedure TestTMachineDecision.TestGetDescription_Text(_Result: String);
var
  R : String;
begin
  R := aMDNode.Text;
