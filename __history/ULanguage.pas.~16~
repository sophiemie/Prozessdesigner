...
const
  ...
  MD_SEL2_DE = 'Genügend/Überschneidete Tage';
  ...
  HT_SEL3_DE = 'MitarbeiterInnen und Gäste';
  HT_SEL4_DE = 'Reise';
  ...
  HD_HINT_DE = 'Es gibt verschiedene Personen, die eine Entscheidung treffen '
                + 'können.';
  MD_HINT_DE = 'Dies sind verschiedene Überprüfungen die das System bereits '
                  + 'überprüfen kann.';
  HT_HINT_DE = 'Es gibt verschidene Formulare, die der Auftragsteller bei einem'
                  + ' Prozess ausfüllen muss.';
  MT_HINT_DE = 'Dies sind Funktionen die bereits vom System durchgeführt werden'
                + ' können.';
